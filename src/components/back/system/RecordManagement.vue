  ...
  <div>
    <el-dialog
      ...
      <el-form v-model="selectedLog" style="text-align: left" ref="dataForm">
        <el-form-item label="模块名" label-width="120px" prop="modul">
          <el-input v-model="selectedLog.modul" autocomplete="off" disabled></el-input>
        </el-form-item>
        <el-form-item label="操作类型" label-width="120px" prop="name">
          <el-input v-model="selectedLog.type" autocomplete="off" disabled></el-input>
        </el-form-item>
        <el-form-item label="描述" label-width="120px" prop="name">
          <el-input v-model="selectedLog.descp" autocomplete="off" disabled></el-input>
        </el-form-item>
        <el-form-item label="方法" label-width="120px" prop="name">
          <el-input v-model="selectedLog.method" autocomplete="off" disabled></el-input>
        </el-form-item>
        <el-form-item label="URL" label-width="120px" prop="name">
          <el-input v-model="selectedLog.uri" autocomplete="off" disabled></el-input>
        </el-form-item>
        <el-form-item label="IP" label-width="120px" prop="name">
          <el-input v-model="selectedLog.ip" autocomplete="off" disabled></el-input>
        </el-form-item>
        <el-form-item label="操作时间" label-width="120px" prop="name">
          <el-input v-model="selectedLog.time" autocomplete="off" disabled></el-input>
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    listLogs () {
      var _this = this
      this.$axios.get('/back/system/logs').then(resp => {
