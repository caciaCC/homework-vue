    ...
    <el-dialog
      ...
      <el-form :model="roleForm" :rules="rules" label-position="left"
        ...
        <el-form-item prop="nameCn">
          <el-input type="text" v-model="roleForm.nameCn"
                    auto-complete="off" placeholder="权限字符"></el-input>
        </el-form-item>
        <el-form-item prop="desc">
          <el-input type="text" v-model="roleForm.des"
...
export default {
  ...
  methods: {
    ...
    createRole () {
      this.$axios
        .post('/back/user/roles/add', {
          name: this.roleForm.name,
          namCn: this.roleForm.nameCn,
